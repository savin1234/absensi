<form action="/departemen/{{ $departemen->kode_dept }}/update" method="POST" id="formdepartemen" enctype="multipart/form-data">
            ...
            <div class="input-icon mb-3">
                              ...
                              <input type="text" name="kode_dept" id="kode_dept" value="{{ $departemen->kode_dept }}" class="form-control" placeholder="kode_dept">
                              </div>
                              <div class="input-icon mb-3">
                                <span class="input-icon-addon">
                                  <!-- Download SVG icon from http://tabler-icons.io/i/user -->
                                ...
                                <input type="text" name="nama_dept" id="nama_dept" value="{{ $departemen->Nama_dept }}" class="form-control" placeholder="nama_dept">
                              </div>
                      </div>
                  <div class="row">
                    <div class="col">
